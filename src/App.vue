...
<template>
  <div id="app" class="bg-[#FFEFCC] fixed w-screen h-screen">
    <Launcher v-if="pageStore.name === 'launcher'" ref="launcher" />
    <WorkInProgressView v-else />
    <!-- <Palette v-if="pageStore.name === 'palette'" /> -->
  </div>
  <Cursor />
  <FPSCounter />
